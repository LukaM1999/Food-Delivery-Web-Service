Vue.component('shoppingCart', {
	...
	methods: {
		...
		async updatePoints(restaurantName){
		...
		async confirmOrder() {
			...
			if (orderResponse.data) {
				...
				this.updatePoints(order.restaurant)
	...
	template: `
	<div>
		<button class="btn btn-dark" type="button" title="Shopping cart" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
